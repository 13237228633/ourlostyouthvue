...
<div class="dynamec children">
      <mt-header :title="''+clientHeight+'/'+wrapperHeight">
 ...
 <mt-loadmore name="loadmoreA"  :top-method="loadTop"  :bottom-method="loadBottom" @top-status-change="handleTopChange" @bottom-status-change="handleBottomChange" :bottom-all-loaded="allLoaded" ref="loadmore">
    ...
    <div class="aaaa">
     <div  style="background-color:#ececec;">
        <div v-for="(item,index,key) in AlbumListJson" v-bind:key="key" class="divContent">
          <div class="divTitle">
              <div class="divImgtitle">
                  <img class="imgTitle"  src="http://q.qlogo.cn/qqapp/101424961/F6D4E6D16F4CA383BC50D3EE740A2495/100">
              </div>
                <router-link class="router-link" to="/dynamic/User">
            ...
            <router-link class="router-link"  :to="'/index/indexDetails/indexDetailsA/'+index">
